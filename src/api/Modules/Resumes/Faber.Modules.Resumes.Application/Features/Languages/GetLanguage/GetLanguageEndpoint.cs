...
public class GetLanguageEndpoint(ILogger<GetLanguageEndpoint> logger)
    : Endpoint<GetLanguageRequest, Results<Ok<GetLanguageResponse>, NotFound>>
{
    ...
    public override async Task<Results<Ok<GetLanguageResponse>, NotFound>> ExecuteAsync(
        GetLanguageRequest req,

...
public class ReorderLanguagesEndpoint(ILogger<ReorderLanguagesEndpoint> logger)
    : Endpoint<ReorderLanguagesRequest, Results<NoContent, NotFound>>
{

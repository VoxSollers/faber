...
public class CreateLanguageEndpoint(ILogger<CreateLanguageEndpoint> logger)
    : Endpoint<CreateLanguageRequest, Results<Ok<CreateLanguageResponse>, NotFound>>
{
    ...
    public override async Task<Results<Ok<CreateLanguageResponse>, NotFound>> ExecuteAsync(
        CreateLanguageRequest req,

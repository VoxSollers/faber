...
public class ReorderExperiencesEndpoint(ILogger<ReorderExperiencesEndpoint> logger)
    : Endpoint<ReorderExperiencesRequest, Results<NoContent, NotFound>>
{

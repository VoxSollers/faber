...
public class DeleteExperienceEndpoint(ILogger<DeleteExperienceEndpoint> logger)
    : Endpoint<DeleteExperienceRequest, Results<NoContent, NotFound>>
{

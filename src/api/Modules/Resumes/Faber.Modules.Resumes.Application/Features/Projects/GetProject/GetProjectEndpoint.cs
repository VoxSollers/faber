...
public class GetProjectEndpoint(ILogger<GetProjectEndpoint> logger)
    : Endpoint<GetProjectRequest, Results<Ok<GetProjectResponse>, NotFound, UnauthorizedHttpResult>>
{
    ...
    public override async Task<Results<Ok<GetProjectResponse>, NotFound, UnauthorizedHttpResult>> ExecuteAsync(

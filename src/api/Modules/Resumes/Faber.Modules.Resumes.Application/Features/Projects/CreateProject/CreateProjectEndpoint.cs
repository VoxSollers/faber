...
public class CreateProjectEndpoint(ILogger<CreateProjectEndpoint> logger)
    : Endpoint<CreateProjectRequest, Results<Ok<CreateProjectResponse>, NotFound>>
{
    ...
    public override async Task<Results<Ok<CreateProjectResponse>, NotFound>> ExecuteAsync(

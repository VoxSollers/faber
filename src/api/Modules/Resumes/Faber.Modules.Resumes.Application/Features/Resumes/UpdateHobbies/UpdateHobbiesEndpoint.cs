...
public class UpdateHobbiesEndpoint(ILogger<UpdateHobbiesEndpoint> logger)
    : Endpoint<UpdateHobbiesRequest, Results<NoContent, NotFound>>
{
    public override void Configure()
    {
        Put("{ResumeId}/hobbies");
        Group<ResumesGroup>();
        Version(1);

...
public class UpdateLocalizationEndpoint(ILogger<UpdateLocalizationEndpoint> logger)
    : Endpoint<UpdateLocalizationRequest, Results<NoContent, NotFound>>
{
    public override void Configure()
    {
        Put("{ResumeId}/localization");
        Group<ResumesGroup>();
        Version(1);

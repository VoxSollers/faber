...
public class CreateLinkEndpoint(ILogger<CreateLinkEndpoint> logger)
    : Endpoint<CreateLinkRequest, Results<Ok<CreateLinkResponse>, NotFound>>
{
    ...
    public override async Task<Results<Ok<CreateLinkResponse>, NotFound>> ExecuteAsync(

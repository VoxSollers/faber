...
public class GetAllCoursesEndpoint(ILogger<GetAllCoursesEndpoint> logger)
    : Endpoint<GetAllCoursesRequest, Results<Ok<GetAllCoursesResponse>, NotFound>>
{
    ...
    public override async Task<Results<Ok<GetAllCoursesResponse>, NotFound>> ExecuteAsync(
        GetAllCoursesRequest req,

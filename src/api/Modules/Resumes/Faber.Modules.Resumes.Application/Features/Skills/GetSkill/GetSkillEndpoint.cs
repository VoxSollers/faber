...
public class GetSkillEndpoint(ILogger<GetSkillEndpoint> logger)
    : Endpoint<GetSkillRequest, Results<Ok<GetSkillResponse>, NotFound>>
{
    ...
    public override async Task<Results<Ok<GetSkillResponse>, NotFound>> ExecuteAsync(
        GetSkillRequest req,

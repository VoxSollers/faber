...
public class GetEducationEndpoint(ILogger<GetEducationEndpoint> logger)
    : Endpoint<GetEducationRequest, Results<Ok<GetEducationResponse>, NotFound>>
{
    ...
    public override async Task<Results<Ok<GetEducationResponse>, NotFound>> ExecuteAsync(
        GetEducationRequest req,

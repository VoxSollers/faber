...
public class ReorderEducationsEndpoint(ILogger<ReorderEducationsEndpoint> logger)
    : Endpoint<ReorderEducationsRequest, Results<NoContent, NotFound>>
{

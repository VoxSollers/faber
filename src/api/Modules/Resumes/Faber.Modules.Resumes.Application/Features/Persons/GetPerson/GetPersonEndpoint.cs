...
public class GetPersonEndpoint(ILogger<GetPersonEndpoint> logger)
    : Endpoint<GetPersonRequest, Results<Ok<GetPersonResponse>, NotFound>>
{
    ...
    public override async Task<Results<Ok<GetPersonResponse>, NotFound>> ExecuteAsync(
        GetPersonRequest req,
